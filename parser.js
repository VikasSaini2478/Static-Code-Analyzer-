...
export class Parser {
  ...
  parseStatement() {
    ...
    if (t.value === "break")    { const loc=this.loc(); this.consume(); this.match("PUNCT",";"); return AST.BreakStatement(loc); }
    if (t.value === "continue") { const loc=this.loc(); this.consume(); this.match("PUNCT",";"); return AST.ContinueStatement(loc); }
